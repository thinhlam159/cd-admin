<template>
  <div class="flex border-b-none border border-gray-200">
    <div class="border-r border-gray-100 w-[5%] flex flex-wrap items-center pl-1">
    ...
    <div class="border-r border-gray-100 w-[35%] flex flex-wrap items-center pl-1">
      <div class="inline p-0 my-2" v-for="(item, index) in productsByCategory" :key="index">
