  ...
  <div class="container">
    <div class="form">
      ...
      <form @submit.prevent="handleLogin">
        ...
        <div class="input-field">
          <input class="pswrd" type="password" required v-model="dataLogin.password" ref="passwordInput">
          <span class="show" @click="togglePassword"><i class="fa fa-eye" aria-hidden="true"></i></span>
...
import {ROUTER_PATH, MODULE_STORE, TYPE_USER} from "@/const";
