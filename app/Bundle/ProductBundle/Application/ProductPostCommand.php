...
class ProductPostCommand
{
     ...
     * @param bool $isAvatar
     */
    public function __construct(string $name, string $code, string $description, int $price, string $monetaryUnitId, string $categoryId, string $measureUnitId, string $productAttributeId, string $productAttributeValue, string $productAttributeCode, string $path, bool $isAvatar)
    {
        $this->name = $name;
        $this->code = $code;
